...
<html>
    <head>
        <title>Contact Us | lifestyleStore.com</title>
...
<div class="container">
    <div class="row">
        <div class="col-sm-10">
		  ...
		  <h3>24 hours|7 days a week| 365 days a year Live Technical Btech Student Support</h3><br>
          <div>
	       ...
	       <div class="contact-info">
	           <h2 class="title">Contact Info</h2>
	            ...
	            <div><h2 class="title">Follow Us On&#58;</h2>
                   <a href="https://www.linkedin.com/in/badal-sharma-72b2bb186/" target="_blank"><img src="./img/logofb.png" alt="fb logo" style="width:30px; height:30px; border:0"></a>
                   <a href="https://twitter.com/badalsharma2741" target="_blank"><img src="./img/logotwitter.png" alt="twitter logo" style="width:30px; height:30px; border:0 padding-left:10px;"></a>
               </div>
            </div>
        </div>
    </div>
